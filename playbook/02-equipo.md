...
Estructura mínima para operar Pauleza: **closer, appointment setter,
...
- **M1 · instantáneo (automático):**
  > Hola {{nombre}} 👋 Soy del equipo de Pauleza. Vi que pediste info para
...
- **M2 · tras llamada perdida:**
  > Te acabo de marcar 📞 Soy de Pauleza (lo de tu página y la app que cotiza).
