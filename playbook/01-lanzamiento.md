# 🚀 Lanzar Pauleza (y portar desde ALTO)

Pauleza es el **caso B** del playbook de ALTO: producto/marca distinta, repo
...
2. ☐ Cuentas propias: subcuenta GHL, cuenta/links de Stripe, dominio, servicio
   en Render (`pauleza`) + su `DATABASE_URL` propia en Supabase (`maid-flow-db`).
...
2. ☐ Adaptar el vocabulario al público de Pauleza (limpiadoras, español).
